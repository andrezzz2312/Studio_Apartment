 ...
 * Wed Jul 06 2022 11:32:43 GMT-0500 (Ecuador Time)
...
var sofa, sofaValue, floorValue, cameraX, shel_1, shelveValue, cameraY, shel_2, sofaPrice, cameraZ, shel_3, floorPrice, interseccion, moving, piso_1, shelveClicked, shelvePrice, piso_2, mouseMove, posicion, recliner, piso_3, info, title, line, rotation_recliner, subTitle, delete_recliner, screen_shot, dowload, upload, json, sofaClicked, sofa_1, sofa_2, sofa_3, getSofaPosition, pdf, total;
...
eventHTMLElem('click', recliner, true, function(event) {
  if (!isSceneLoaded('recliner.glb')) {
    ...
    registerOnDrag('Leather_Recliner', false, [0], function() {}, function() {
      dragMove('Leather_Recliner', 'XY', '(Wph),Q9xkKTQCjt_3/|', '4N3*RgNyIz^Bivei=;51');
...
eventHTMLElem('mousedown', ['WINDOW'], false, function(event) {
  mouseMove = true;
  eventHTMLElem('mouseup', ['WINDOW'], false, function(event) {
    mouseMove = false;
  });
});
eventHTMLElem('mousemove', ['WINDOW'], false, function(event) {
